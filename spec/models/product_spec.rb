...
RSpec.describe Product, type: :model do
  before do
    @productAll = Product.new(:name => "Headphones", :description => "listen to music", :price_cents => 4700, :category_id => 1, :quantity => 39)
    @productName = Product.new(:description => "listen to music", :price_cents => 4700, :category_id => 2, :quantity => 39)
    @productQuantity = Product.new(:name => "Headphones", :description => "listen to music", :price_cents => 4700, :category_id => 1)
    @productPrice = Product.new(:name => "Headphones", :description => "listen to music", :category_id => 2, :quantity => 39)
    @productCategory = Product.new(:name => "Headphones", :description => "listen to music", :price_cents => 4700, :quantity => 39)
